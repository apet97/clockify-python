...
For version `0.2.0`, create an environment and install the package:

```bash
uv venv .venv
uv pip install --python .venv/bin/python clockify-python-115==0.2.0
```

Install `clockify-python-115[mcp]==0.2.0` when you need the MCP server.
